...
Dans cette situation, les parties ne considèrent leur opinion que comme l’état d’avancement de leur réflexion sur le sujet et non comme une certitude dogmatique ou un horizon indépassable. Elles admettent qu’elles ne \exergue{connaissent} pas la réponse à la question débattue mais n’en ont qu’une idée, tout au plus approchante. Aussi le \mainabbr{} leur permet-il justement de faire progresser leur quête d’amélioration.
...
\begin{description}
  ...
  \item[Élément significatif] Il s’agit de contributions au débat pertinentes \incise{mais non nécessairement valides} qui ne seront pas exclues du débat.
...
\subsubsection{Détail des prérequis}
...
\paragraph{}
Une session de \mainabbr{} n’est pas clôturé lorsqu’elle prend fin pour des raisons logistiques comme la nécessité pratique pour les participants de se retirer après un temps imparti. En revanche, la session est clôturée lorsque l’ensemble des parties aboutit à une \exergue{conclusion}. Une conclusion pouvant prendre deux principaux aspects
\begin{SRlist}
...
\paragraph{}
Toute fois, certains évènements, au court de la conversation, peuvent intervenir auquel cas le \mainabbr{} propose des \exergue{mesures} qui prennent effet immédiatement.
...
%TODO Erreurs récurrentes dans un sujet
...
\epigraph{Quand vous discutez avec un adversaire de droite, traitez le de fasciste, le temps qu’il se défende, il ne pourra pas développer d’autres arguments.}{Attribué à \bsc{Staline} par les milieux fascistes mais jamais authentifiée. Peu importe, cette citation me plaît.}
\subsubsection{État des lieux}
