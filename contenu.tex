...
Dans cette situation, les parties ne considèrent leur opinion que comme l’état d’avancement de leur réflexion sur le sujet et non comme une certitude dogmatique ou un horizon indépassable. Elle admettent qu’elles ne \exergue{connaissent} pas la réponse à la question débattue mais n’en ont qu’une idée, tout au plus approchante. Aussi le \mainabbr{} leur permet-il justement de faire progresser leur quête d’amélioration.
...
\epigraph{Quand vous discutez avec un adversaire de droite, traitez le de fasciste, le temps qu’il se défende, il ne pourra pas développer d’autres arguments.}{Attribué à \bsc{Staline} par les milieux fascistes mais jamais authentifiée. Peut importe, cette citation me plaît.}
\subsubsection{État des lieux}
