...
\epigraph{Plus une discussion en ligne dure longtemps, plus la probabilité d’y trouver une comparaison impliquant les nazis ou Adolf \bsc{Hitler} s’approche de 1.}{\cite{godwinDeclaration}}
...
\paragraph{}
En outre, dans les exemples de discutions seront utilisés des noms de personnages dont les innitiales sont fonction de l’ordre de prise de parole. Les noms utilisés augureront généralement une personnalité stéréotypée ou une intention.
